...
<?php if (!empty($this->options->Show_what) && in_array('MoOxPjax', $this->options->Show_what)): ?>
<script>
  var pjax = new Pjax({
...
<!-- jQuery版本Pjax Start -->
<?php if (!empty($this->options->Show_what) && in_array('jQueryPjax', $this->options->Show_what)): ?>
...
<?php endif; ?>
<!-- jQuery版本Pjax End -->
<script src="<?php $this->options->themeUrl()?>assets/js/Mix.js"></script>
